...
PACKAGES += "kernel-module-qca-nss-gre-mgr"
...
do_install() {
	...
	install -m 0644 ${S}/qca-nss-gre-mgr${KERNEL_OBJECT_SUFFIX} ${D}${base_libdir}/modules/${KERNEL_VERSION}/kernel/drivers/${PN}
	install -d ${D}${includedir}/qca-nss-gre-mgr
	install -m 0644 ${S}/Module.symvers ${D}${includedir}/qca-nss-gre-mgr/Module.symvers
}

KERNEL_MODULE_AUTOLOAD += "qca-nss-gre-mgr"
