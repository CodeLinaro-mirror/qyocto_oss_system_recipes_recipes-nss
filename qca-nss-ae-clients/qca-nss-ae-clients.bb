...
OVERRIDES:append = ":qca-nss-ppe-vlan-mgr:qca-nss-ppe-bridge-mgr:qca-nss-ppe-pppoe-mgr:qca-nss-ppe-lag-mgr:qca-nss-ppe-dsa-mgr:qca-nss-ppe-ath-clients"
...
PACKAGES += "kernel-module-qca-nss-ae-clients "
...
RDEPENDS-qca-nss-ppe-ath-clients   = "qca-nss-ppe-vp"
...
NSS_PPE_MODULES:append:qca-nss-ppe-ath-clients = " ath_clients=y"
...
do_install:append:qca-nss-ppe-bridge-mgr() {
	...
	install -m 0755 ${WORKDIR}/files/ppe_bridge_mgr_dump ${D}${bindir}/ppe_bridge_mgr_dump
}
...
do_install:append:qca-nss-ppe-lag-mgr() {
	...
	install -d ${D}${bindir}
	install -m 0755 ${WORKDIR}/files/ppe_lag_dump ${D}${bindir}/ppe_lag_dump
}
...
do_install:append:qca-nss-ppe-ath-clients() {
        install -m 0644 ${S}/clients/ath_client/qca-nss-ppe-ath-clients${KERNEL_OBJECT_SUFFIX} ${D}${base_libdir}/modules/${KERNEL_VERSION}/kernel/drivers/${PN}
}

FILES:${PN} = " ${bindir}/qca-nss-ppe-bridge-mgr \
		${bindir}/ppe_bridge_mgr_dump \
		${bindir}/ppe_lag_dump \
...
KERNEL_MODULE_AUTOLOAD:append:qca-nss-ppe-ath-clients = " qca-nss-ppe-ath-clients"
